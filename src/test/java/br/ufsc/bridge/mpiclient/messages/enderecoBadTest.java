...
public class enderecoBadTest {

	@Test
	public void testeEnderecoBad()throws MPIValidationException, IOException{
	...
	assertThat(messageXml)
				.isNotBlank()
				.isEqualTo(FileLoader.loadAsString("/requests/EnderecoBad.xml"));
	}
}
