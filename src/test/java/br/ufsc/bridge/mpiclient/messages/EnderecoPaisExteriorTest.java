...
public class EnderecoPaisExteriorTest {

	@Test
	public void testeEnderecoExterior()throws MPIValidationException, IOException{
	...
	assertThat(messageXml)
				.isNotBlank()
				.isEqualTo(FileLoader.loadAsString("/requests/EnderecoPaisExterior.xml"));
	}
}
