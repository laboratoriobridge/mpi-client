...
public class PRPA_IN201301UV02RemoveContatoTest {
		...
		public void pedroMoreiraLauro() throws MPIValidationException, IOException, SAXException {
			Cidadao cidadao = Cidadao.builder()
					...
					.contato(new Contato("+55-61-82997451", TipoContato.TELEFONE_RESIDENCIAL,true))
					.contato(new Contato("foo@gmail.com", TipoContato.EMAIL,false))
					.contato(new Contato("bar@hotmail.com", TipoContato.EMAIL,false))
					.cpf("01030433143")
			...
			assertThat(messageXml)
					.isNotBlank()
					.isEqualTo(FileLoader.loadAsString("/requests/DeleteContato.xml"));
		}
